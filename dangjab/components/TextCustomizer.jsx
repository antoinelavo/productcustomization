...
function TextCustomizer({ textSettings, onTextChange, templateMode = false }) {
    ...
    <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-gray-200">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-xl font-bold text-gray-800 flex items-center">
          ...
          이름 및 문구 넣기
          {templateMode && <span className="ml-2 text-sm text-blue-600">(시안 사용)</span>}
        </h3>
        <button
          onClick={resetText}
      ...
      {templateMode && (
        <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
          <p className="text-sm text-blue-800">
            시안을 사용하시면 이름만 편집할 수 있습니다.
          </p>
        </div>
      )}

      <div className="space-y-4">
        {/* Top Text (Curved) - Always visible */}
        <div>
        ...
        {/* Text Color - Hidden in template mode */}
        {!templateMode && (
          <div>
